    ...
    <header className="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
          ...
          <form action="#" method="POST">
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-transparent outline-none pl-9 pr-4 font-medium focus:outline-none xl:w-125 border-none focus:border-none"
              />
            </div>
          </form>
        </div>
        ...
        <div className="flex items-center gap-3 2xsm:gap-4">
          ...
          <div>
            {currentAccount ? '' : <ConnectButton className="!bg-black !text-bodydark1 dark:!text-black dark:!bg-white" />}
          </div>
          {/* <!-- User Area --> */}
          {currentAccount ? <DropdownUser address={currentAccount.address} /> : ''}
          {/* <!-- User Area --> */}
        </div>
      </div>
    </header>
